...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    #address_1 = models.CharField(_('address 1'), max_length=200, blank=True)
    #address_2 = models.CharField(_('address 2'), max_length=200, blank=True)
    ...
    user_type = models.PositiveSmallIntegerField(_('user type'), choices=USER_TYPE_CHOICES, null=True, blank=True)
